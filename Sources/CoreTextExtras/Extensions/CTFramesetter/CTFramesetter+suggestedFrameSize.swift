...
extension CTFramesetter {
    ...
    ///
    /// - Returns: The suggested frame size that fits within the given constraints.
    @inlinable
    public func suggestedFrameSize(
        ...
        let (size, _) = suggestedFrameSize(for: range, constrainedBy: constraints, attributes: attributes)
        return size
    }
